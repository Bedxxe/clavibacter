...
--annotation grap-files/merged_abundance.annot.txt --most_abundant 80 --annotations 2 \
...
echo Color for Proteobacteria changed from $#2d19ff to $#e6ab02
sed 's/#2d19ff/#7570b3/g' grap-files/merged_abundance.annot.txt > temp.txt && mv temp.txt grap-files/merged_abundance.annot.txt
...
echo Color for Chloroflexi changed from $#00bfff to $#1b9e77
sed 's/#00bfff/#e7298a/g' grap-files/merged_abundance.annot.txt > temp.txt && mv temp.txt grap-files/merged_abundance.annot.txt

echo Color for Bacteroidetes changed from $#00ff80 to $#7570b3
sed 's/#00ff80/#e6ab02/g' grap-files/merged_abundance.annot.txt > temp.txt && mv temp.txt grap-files/merged_abundance.annot.txt
...
graphlan.py --dpi 300 --size 10 grap-files/merged_abundance.xml rpd-graphlan_graph.png --external_legends